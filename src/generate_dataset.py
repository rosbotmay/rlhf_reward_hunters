...
if __name__ == "__main__":
    ...
    scores_pi1 = reinforce_rwd2go_baseline(
        env, policy_pi1, optimizer_pi1, early_stop=True, n_episodes=2000, max_reward=495
    )
    ...
    scores_pi2 = reinforce_rwd2go_baseline(
        env, policy_pi2, optimizer_pi2, early_stop=True, n_episodes=2000, max_reward=350
    )
